...
@section('conteudo')
    ...
    <div class="banner">
        <div class="container">
            <div class="span_1_of_1">
                <h2>Ache ja, o seu prato predilecto<br> Onde quer que esteja.</h2>
                <div class="search">
                    <ul class="nav1">
                        <li id="search">
                            <form action="" method="get">
                                <input type="text" name="search_text" id="search_text" placeholder="Digite a sua cidade"/>
    ...
    <div class="grid_1">
        <h3>Mais de mil restaurantes registados na nossa plataforma com cardapios de varios sabores</h3>
